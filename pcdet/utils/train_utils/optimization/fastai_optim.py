...
class OptimWrapper():
    ...
    # def create(cls, model, optim_cfg, **kwargs):
    #     import torch.optim as optim
    #     # opt = optim.Adam(filter(lambda p: p.requires_grad, model.parameters()), lr=optim_cfg.LR,
    #     #                  weight_decay=optim_cfg.WEIGHT_DECAY, betas=(0.9, 0.99))
    #     opt = optim.Adam(model.parameters(), lr=optim_cfg.LR,
    #                      weight_decay=optim_cfg.WEIGHT_DECAY, betas=(0.9, 0.99))
    #     return opt
