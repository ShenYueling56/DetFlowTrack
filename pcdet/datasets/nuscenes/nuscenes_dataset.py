...
class NuScenesDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None, total_gpus=1):
        ...
        super().__init__(
            dataset_cfg=dataset_cfg, class_names=class_names, training=training, root_path=root_path, logger=logger, total_gpus=1
        )
        self.infos = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default="/home/shenyl/Documents/code/SSDT/tools/cfgs/dataset_configs/nuscenes_dataset.yaml", help='specify the config of dataset')
    ...
    if args.func == 'create_nuscenes_infos':
        ...
        DATA_PATH = Path("/media/shenyl/sweeper1/nuScenes/")
