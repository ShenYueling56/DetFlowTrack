...
last_seq = 16
import torchsnooper
class SoloDetSceneflowPoint(DetSceneflow3DTemplate):
    ...
    def forward(self, batch_dict):
        ...
        if self.training | first_frame:
            ...
            last_batch_dict = batch_dict2
            last_seq = batch_dict1['seq_id'][0]
        # print("batch after det ", batch_dict2.keys())
        # print("center_cls_preds ", batch_dict2['batch_cls_preds'].shape)
        # print("center_box_preds ", batch_dict2['batch_box_preds'].shape)
