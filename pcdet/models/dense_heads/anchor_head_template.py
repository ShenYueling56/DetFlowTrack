...
class AnchorHeadTemplate(nn.Module):
    ...
    def get_cls_layer_loss(self, ret_dict):
        cls_preds = ret_dict['cls_preds']
        box_cls_labels = ret_dict['box_cls_labels']
    ...
    def get_box_reg_layer_loss(self, ret_dict):
        ...
        box_dir_cls_preds = ret_dict.get('dir_cls_preds', None)
        box_reg_targets = ret_dict['box_reg_targets']
        box_cls_labels = ret_dict['box_cls_labels']
    ...
    def get_loss(self, ret_dict, tb_dict=None):
        ...
        cls_loss, tb_dict_cls = self.get_cls_layer_loss(ret_dict)
        box_loss, tb_dict_box = self.get_box_reg_layer_loss(ret_dict)
